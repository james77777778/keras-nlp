...
from keras_hub.src.models.depth_anything.silog import SiLog
        ...
        **kwargs,
        ...
        Args:
            ...
            loss: `"auto"`, a loss name, or a `keras.losses.Loss` instance.
                Defaults to `"auto"`, where a `SiLog` loss will be applied for
                the depth estimation task. See `keras.Model.compile` and
                `keras.losses` for more info on possible `loss` values.
        ...
        if loss == "auto":
            loss = {"depths": SiLog(max_depth=self.max_depth)}
        if metrics == "auto":
